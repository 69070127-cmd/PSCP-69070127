...
```text
โจทย์นี้ให้คำนวณ ยอดเงินที่นักเรียนต้องจ่ายหลังจากได้รับส่วนลด โดยนักเรียนจะซื้อสินค้าในร้านสหกรณ์จำนวนหลายรายการ และส่วนลดจะขึ้นอยู่กับสถานะการเป็นสมาชิกสหกรณ์
input:
...
constraints:
n > 0 ดังนั้นจะมีสินค้าที่ซื้ออย่างน้อย 1 รายการ
สถานะสมาชิกมีเพียง Y หรือ N
ราคาสินค้าเป็นจำนวนเต็มหรือจำนวนจริง
ต้องนำราคาสินค้าทั้งหมดมารวมกันก่อน แล้วจึงตรวจสอบเงื่อนไขส่วนลด
ต้องแสดงผลสุดท้ายเป็นทศนิยม 2 ตำแหน่ง
```
...
ปัด net เป็นทศนิยม 2 ตำแหน่งแบบ Round Half Up
...
```text
 เหมือนกับแผนแรก รวมราคาสินค้าทั้งหมดแล้วตรวจสอบสถานะสมาชิกและเงื่อนไขส่วนลดแล้วคำนวณยอดแล้ว ปัดเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
ตรวจสอบกรณีไม่เป็นสมาชิก แต่ยอดรวม ถึง 500 บาท
```
...
```text
ตรวจสอบกรณีไม่เป็นสมาชิกและยอดรวม 
```
