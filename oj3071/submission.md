...
```text
โจทย์กำหนดจำนวน A และ B โดย A < B และต้องการหาว่า มีจำนวนเต็มกี่จำนวนในช่วงตั้งแต่ A ถึง B รวมทั้ง A และ B ที่เมื่อนำไปหารด้วย d แล้วมีเศษเท่ากับ r
Input:
บรรทัดที่ 1 จํานวนนับ A 
บรรทัดที่ 2 จํานวนนับ B 
บรรทัดที่ 3 จํานวนนับ d (ตัวหาร) 
บรรทัดที่ 4 จํานวนนับ r (เศษ)
Output:
N ซึ่งเป็น จำนวนตัวเลขในช่วง [A, B] ที่หารด้วย d แล้วเหลือเศษ r
Constraints:
A < B และ r < d
```
...
สำหรับ i ตั้งแต่ A ถึง B
    ถ้า i หารด้วย d แล้วเหลือเศษ r
        เพิ่มค่า ans ขึ้น 1
...
```text
เหมือนกับแผนแรก คือ วนตรวจทุกจำนวนตั้งแต่ A ถึง B แล้วใช้ % ตรวจว่าเมื่อหารด้วย d เหลือเศษ r หรือไม่ ถ้าตรงเงื่อนไขก็เพิ่ม ans ขึ้น 1 สุดท้ายแสดงค่า ans ออกมา
```
...
```text
ทดสอบกรณีที่เศษเป็น 0 ซึ่งหมายถึงหารลงตัว
```
...
```text
ทดสอบกรณีที่ไม่มีจำนวนใดตรงเงื่อนไขเลย เพื่อให้แน่ใจว่าโปรแกรมสามารถตอบ 0 ได้
```
