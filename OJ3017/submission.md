...
```text
โจทย์ให้หาค่าอาหารที่บวกค่าบริการกับvatแล้ว
Input:
ราคาอาหารทั้งหมด

Output:
ราคาอาหารที่คำนวนค่าบริการและvatแล้ว และทศนิยมสองตำแหน่ง
...
```text
Step 1: รับค่าอาหาร
Step2: หาค่าบริการ โดย ราคาอาหาร * 0.10
Step3: ตรวจสอบว่า ค่าบริการ  < 50 หรือไม่
Step4: ถ้าจริง ให้เปลี่ยนค่าบริการ 50
Step5: แล้วตรวจสอบว่า ค่าบริการ > 1000 หรือไม่
Step6: ถ้าจริง ให้เปลี่ยนค่าบริการ 1000
Step7: ค่าอาหาร2 = เอาค่าบริการ + ค่าอาหาร
Step8: หาvat โดย ค่าอาหาร2 * 0.07
Step9: ค่าอาหารทั้งหมด = vat + ค่าอาหาร2
Step10: พิมพ์ค่าอาหารทั้งหมดและลบเศษเหลือสองตัว
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก เพราะมันคำนวนได้
```
...
```text
ตรวจสอบว่าคำนวนได้ตรงตามเป้าไหม
```
