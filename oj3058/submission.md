...
```text
โจทย์กำหนดให้เราสร้างสะพานที่มีความยาวทั้งหมด goal นิ้ว โดยมีอิฐอยู่ 2 ประเภท
อิฐก้อนเล็ก ยาว 1 นิ้ว และมีทั้งหมด a ก้อน
อิฐก้อนใหญ่ ยาว 5 นิ้ว และมีทั้งหมด b ก้อน
Input:
บรรทัดที่ 1: จำนวนอิฐก้อนเล็ก a
บรรทัดที่ 2: จำนวนอิฐก้อนใหญ่ b
บรรทัดที่ 3: ความยาวสะพานที่ต้องการ goal
output:
ให้แสดงจำนวน อิฐก้อนเล็กที่ต้องใช้ 
constraints:
a, b และ goal เป็น จำนวนเต็มบวก
```
...
```text
เหมือนกับแผนแรก เลือกใช้อิฐใหญ่ให้มากที่สุดก่อน แล้วใช้อิฐเล็กเติมส่วนที่เหลือ
```
...
```text
ใช้อิฐใหญ่ 2 ก้อน = 10 นิ้ว เหลือ 3 นิ้ว
```
...
```text
เหลือ 3 นิ้ว แต่อิฐเล็กมีแค่ 2 ก้อน
```
...
```text
ใช้อิฐใหญ่ 2 ก้อน = 10 นิ้ว เหลือ 1 นิ้ว
```
