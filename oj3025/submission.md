...
```text
โจทย์ให้ เดือนกับวัน และให้ดูเป็นเดือนอะไร
Input:
วัน กับ เดือน
...
```text
step1: ดูวันกับเดือน
step2: ตรวจว่า เดือน เป็น [1,2] หรือ เดือน == 3 และ วันน้อยกว่า 21 หรือไหม
step3: ถ้าใช้ ฤดู = "winter"
step4: ถ้าไม่ตรวจว่า เดือน == 3 และ วัน > 20
step5: ถ้าใช้ ฤดู = "spring"
step6: ถ้าไม่ตรวจว่า เดือน เป็น [4,5] หรือ เดือน == 6 และ วันน้อยกว่า 21 หรือไหม
step7: ถ้าใช้ ฤดู = "spring"
step8: ถ้าไม่ตรวจว่า เดือน == 6 และ วัน > 20
step9: ถ้าใช้ ฤดู = "summer"
step10: ถ้าไม่ตรวจว่า เดือน เป็น [7,8] หรือ เดือน == 9 และ วันน้อยกว่า 21 หรือไหม
step11: ถ้าใช้ ฤดู = "summer"
step12: ถ้าไม่ตรวจว่า เดือน == 39และ วัน > 20
step13: ถ้าใช้ ฤดู = "fall"
step14: ถ้าไม่ตรวจว่า เดือน เป็น [10,11] หรือ เดือน == 12 และ วันน้อยกว่า 21 หรือไหม
step15: ถ้าใช้ ฤดู = "fall"
step16: ถ้าไม่ตรวจว่า เดือน == 1 และ วัน > 20
step17: ถ้าใช้ ฤดู = "winter"
step18 แสดง ฤดู
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก เพราะมันใช่ได้ผล
```
