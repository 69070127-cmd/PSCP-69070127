...
```text
โจทย์ต้องให้เปลียนหน่วยอุณหภูมิ
input:
ค่าอุณหภูมิ
หน่วยที่ยังไม่เปลียน
หน่วยที่ต้องการเปลียน
out put:
เป็นค่าอุณหภูมิที่เปลียนหน่วย
Constraints:
input ค่าอุณหภูมิเป็นทศนิยมก็ได้
หน่วยอุณหภูมิเป็น (C, F, K, R)
```
...
```text
Step1: รับค่าอุณหภูมิ
Step2: รับหน่วยของอุณหภูมิเดิม
Step3: รับหน่วยของอุณหภูมิที่ต้องการเปรียน
Step4: เปรียนทุกหน่วยเป็น C
Step5: ถ้าหน่วยของอุณหภูมิเดิมเป็น F ให้ c = (ค่าอุณหภูมิ - 32) * 5 / 9
Step6: ถ้าหน่วยของอุณหภูมิเดิมเป็น K ให้ c = ค่าอุณหภูมิ - 273.15
Step7: ถ้าหน่วยของอุณหภูมิเดิมเป็น R ให้ c = ค่าอุณหภูมิ * 5 / 9 - 273.15
Step8: ถ้าหน่วยของอุณหภูมิเดิมเป็น C ให้ c = ค่าอุณหภูมิ
Step9: เป็น C เป็นหน่วยที่ต้องการ
Step10: ถ้าหน่วยของอุณหภูมิที่ต้องการเปรียนเป็น C ให้คำตอบเป็น c
Step11: ถ้าหน่วยของอุณหภูมิที่ต้องการเปรียนเป็น F ให้คำตอบเป็น c * 9 / 5 + 32
Step12: ถ้าหน่วยของอุณหภูมิที่ต้องการเปรียนเป็น K ให้คำตอบเป็น c + 273.15
Step13: ถ้าหน่วยของอุณหภูมิที่ต้องการเปรียนเป็น R ให้คำตอบเป็น (c + 273.15) * 9 / 5
Step14: แสดงคำตอบเป็นทศนิยม2ตำแหน่ง
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก เปรียนหน่วยเป็น C ก่อน แล้วเปลียนหน่วยอุณหภูมิที่ต้องการ
```
...
```text
ตรวจสอบว่าเปลียนหน่วยอุณหภูมิได้ไหม
```
