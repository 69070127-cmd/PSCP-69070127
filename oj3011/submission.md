...
Output:
สีที่ถูกผสมแล้ว หรือ error ถ้ามีสีอื่นนอกจากแม่สี
...
Step 1: รับสีแรก
Step 2: รัยสีที่สอง
Step 3: ตรวจว่า {สีแรก, สีที่สอง}  == {"Red", "Yellow"}
Step 4: ถ้าจริง ให้พิมพ์ "Orange"
Step 5: แลัวตรวจว่า {สีแรก, สีที่สอง}  == {"Red", "Blue"}
Step 6: ถ้าจริง ให้พิมพ์ "Violet"
Step 7: แลัวตรวจว่า {สีแรก, สีที่สอง}  == {"Yellow", "Blue"}
Step 8: ถ้าจริง ให้พิมพ์ "Green"
Step 9: ถ้าไม่จริง ให้พิมพ์ "Error"
```
...
```text
วิธีสุดท้ายของผมไม่เหมือนกับแผนแรก เพราะผมเพื่มการตรวจสอบว่า {สีแรก, สีที่สอง}  == {"Red", "Red"}
และ {สีแรก, สีที่สอง}  == {"Yellow", "Yellow"} และ {สีแรก, สีที่สอง}  == {"Blue", "Blue"}
```
...
```text
ตรวจว่าได้ผลลัพธ์สีที่ผสมได้ที่ไม่ใช่แม่สี
```
...
```text
ตรวจว่าได้ผลลัพธ์สีที่ผสมได้ที่เป็นสีเดียวกัน
```
