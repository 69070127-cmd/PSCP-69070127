...
```text
Input:
รับตัวอักษรภาษาอังกฤษ 5 ตัว
Output:
แสดงผลตัวเล็ก และเรียงกลับด้าน
Constraints:
input เป็นตัวภาษาอังกฤษ 5 ตัว
```
...
```text
Step 1: รับตัวอักษรภาษาอังกฤษยาว 5 ตัว  และเปลี่ยนเป็นตัวเล็ก โดยใช้Method .lower()
Step2: พิมพ์ ตัวอักษรภาษาอังกฤษยาว 5 ตัว ที่กลับด้านแล้ว โดยใช้ String Slicing
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ผมใช่Method เปลี่ยนเป็นตัวเล็กและใช้String Slicing เพื่อกลับด้านตัวตัวอักษร
```
...
```text
เพื่อดูว่ามันกลับด้านตัวอักษรได้ไหม
```
...
```text
เพื่อดูว่ามันกลับด้านตัวอักษรได้ไหม และเปลียนเป็นตัวเล็กได้ไหม
```
