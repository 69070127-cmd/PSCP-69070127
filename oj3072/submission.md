...
```text
Step 1:รับข้อความละเปลียนเป็นตัวเล็ก
Step 2:สร้างลิสต์ aeiou = ["a", "e", "i", "o", "u"]
Step 3:วนลูปทีละสระ
Step 4:นับจำนวนสระนั้น
Step 5:แสดงจำนวนสระ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก สร้างlist และวนลูปที่ละสระ และนับจำสระและแสดงมัน
```
