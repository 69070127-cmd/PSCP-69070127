...
```text
โจทย์ให้ค่าสูงสุด กับ คะแนนรวม3คะแนน และให้หาว่าค่ามากที่สุดกับค่าตํ่าสุดต่างกันเกินสองหรือไม่
input:
...
constraints: 
input ค่าสูงสุดได้10คะแนน และค่าตํ่าสุดต้องไม่ติดลบ
...
```text
Step 1: รับค่า คะแนนรวมสามคน
Step 2: รับค่า คะแนนสูงสุด
Step 3: หาค่าตํ่าสุดที่เป็นไปได้ โดย นํา คะแนนรวมสามคน - (2 * คะแนนสูงสุด) โดยไม่ตํ่ากว่า0
Step 4: ถ้า คะแนนสูงสุด - ค่าตํ่าสุด > 2
Step 5: ถ้าใ่ช่พิมพ์ "surprising"
Step 6: ถ้าไม่ใช่พิมพ์ "Not surprising"
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก หาคะแนนตํ่านสุดที่เป็นไปได้และไปลบคะแนนสูงสุดและนำมาดูว่าต่างกันเกิน2ไหม
```
...
```text
ตรวจสอบว่าค่าไม่ต่างเกินสองจะพิมพ์ "Not surprising" ไหม
```
...
```text
ตรวจสอบว่าค่าต่างเกินสองจะพิมพ์ "surprising" ไหม
```
...
```text
ตรวจสอบว่าค่าตํ่าสุดได้ติดลบไหม
```
