...
```text
โจทย์ให้แสดงตัวเลขตั้งแต่ N ลงมาถึง 0 ที่หารด้วย 10 ลงตัว
input:
โปรแกรมรับจำนวนเต็มหนึ่งค่า n
output:
ตัวเลขตั้งแต่ N ลงมาถึง 0 ที่หารด้วย 10 ลงตัว
Constraints:
N เป็นจำนวนเต็มบวก
```
...
```text
step1:รับค่าn
step2:หาจำนวนวนวนลูป 10 ลงตัวโดยนำ num1 = n // 10
step3:สร้างลิสต์เริ่มต้น item = [0]
step4:กำหนดตัวแปรเริ่มต้น x = 10
step5:วนลูปตามจำนวย num1
step6:เพื่ม x เข้าลิสต์
step7:เพื่มค่า x += 10
step8:แสดงลิสต์โดยที่เรียงค่าจากมากมาน้อย และแตกลิสต์ออกมา
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก สร้างลูปเพื่มค่าในลิสต์ที่ละ10 จนกว่าจะครบจำรอบที่ ท // 10
```
