...
```text
โจทย์ให้ รับแต้มของไพ่ และ สัญลักษณ์ของไพ่ จากนั้นให้แปลงให้เป็นชื่อไพ่แบบเต็ม
Input:
รับแต้มไพ่ และ สัญลักษณ์ไพ่
Output:
แสดงชื่อเต็มของไพ่
Constraints:
แต้มมีได้เฉพาะ 2-10, A, J, Q, K เป็นตัวเล็กตัวใหญ่ได้หมด
สัญลักษณ์มีได้เฉพาะ D, H, S, C จะเป็นตัวเล็กตัวใหญ่ได้หมด
```
...
```text
Step 1: อ่านรหัสไพ่ x
Step 2: แยกแต้มไพ่จากตัวอักษรสัญลักษณ์ โดยตัวสุดท้ายคือสัญลักษณ์ และส่วนที่เหลือคือแต้ม
Step 3: ตรวจสอบสัญลักษณ์ D, H, S, C และเปลี่ยนเป็นชื่อเต็ม
Step 4: ตรวจสอบแต้ม A, J, Q, K และเปลี่ยนเป็นชื่อเต็ม ถ้าเป็นตัวเลขให้ใช้ตัวเลขเดิม
Step 5: พิมพ์แต้มไพ่ ตามด้วย " of " และชื่อสัญลักษณ์ไพ่
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก รับค่าแต้มไผ่และสัญลักษณ์ และตรวจสอบว่าแต่ละตัวตรงกับอะไร และแสดงผลในแบบแต้ม of สัญลักษณ์
```
