...
```text
โจทย์นี้ให้เขียนโปรแกรมสำหรับ คำนวณค่าธรรมเนียมการส่งพัสดุ
Input:
บรรทัดที่ 1 รับ ต้นทางและปลายทาง เป็นรหัสภาษาอังกฤษตัวพิมพ์ใหญ่ เช่น UBP PKT
บรรทัดที่ 2 รับ น้ำหนักพัสดุ ซึ่งสามารถเป็นเลขทศนิยมได้ เช่น 3.33
Output:
ถ้าเส้นทางถูกต้อง ให้แสดง ค่าธรรมเนียมการส่งพัสดุ โดยแสดงทศนิยม 2 ตำแหน่ง
ถ้าเส้นทางไม่มีอยู่ในตาราง ให้แสดง Error
Constraints:
เส้นทางที่สามารถส่งได้มีเพียง 6 เส้นทาง ได้แก่
BKK → CNX
CNX → UBP
UBP → BKK
BKK → PKT
...
```text
รับค่า ต้นทาง และ ปลายทาง
รับค่า น้ำหนักพัสดุ

ถ้า ต้นทาง = BKK และ ปลายทาง = CNX
    ค่าธรรมเนียมเริ่มต้น = 10
    ค่าธรรมเนียมน้ำหนัก = 30

ถ้า ต้นทาง = CNX และ ปลายทาง = UBP
    ค่าธรรมเนียมเริ่มต้น = 15
    ค่าธรรมเนียมน้ำหนัก = 40

ถ้า ต้นทาง = UBP และ ปลายทาง = BKK
    ค่าธรรมเนียมเริ่มต้น = 20
    ค่าธรรมเนียมน้ำหนัก = 40

ถ้า ต้นทาง = BKK และ ปลายทาง = PKT
    ค่าธรรมเนียมเริ่มต้น = 25
    ค่าธรรมเนียมน้ำหนัก = 50

ถ้า ต้นทาง = PKT และ ปลายทาง = CNX
    ค่าธรรมเนียมเริ่มต้น = 30
    ค่าธรรมเนียมน้ำหนัก = 60

ถ้า ต้นทาง = UBP และ ปลายทาง = PKT
    ค่าธรรมเนียมเริ่มต้น = 40
    ค่าธรรมเนียมน้ำหนัก = 70

ถ้าไม่ตรงกับเส้นทางใดเลย
    แสดง "Error"
ถ้าไม่
    คำนวณ ค่าจัดส่ง = ค่าธรรมเนียมเริ่มต้น + (น้ำหนักพัสดุ × ค่าธรรมเนียมน้ำหนัก)
    แสดงค่าจัดส่ง โดยมีทศนิยม 2 ตำแหน่ง
```
...
```text
เหมือนกับแผนแรก ตรวจสอบคู่ของต้นทางและปลายทางกับข้อมูลเส้นทางที่กำหนดไว้ จากนั้นนำค่าธรรมเนียมเริ่มต้นและค่าธรรมเนียมน้ำหนักมาคำนวณตามสูตร หากไม่พบเส้นทางก็แสดง Error
```
...
```text
ดูว่าโปรแกรมเลือกอัตราค่าธรรมเนียมได้ถูกต้องไหม
```
