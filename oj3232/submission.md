...
```text
โจทย์ จำนวนการกระโดดของกบที่ลดลงที่ละ 2 ว่าต้องกระโดดกี่รอบถึงจะถีง
Input
X = ระยะทางที่กบกระโดดได้ในครั้งแรก จำนวนเต็ม
Y = ระยะทางถึงเป้าหมาย จำนวนเต็ม
Output:
แสดงจำนวนที่กบต้องกระโดด
Constraints:
1 ≤ X ≤ 1000
1 ≤ Y ≤ 100000
ระยะกระโดดจะลดลงครั้งละ 2 เมตร
```
...
Step 2: กำหนด total = 0, count = 0 และ jump = X
Step 3: ตรวจว่า jump > 0 และ total < Y หรือไม่
Step 4: ถ้าจริง ให้ total = total + jump
Step 5: เพิ่มจำนวนครั้งที่กระโดด count ขึ้น 1
Step 6: ลดระยะกระโดด jump ลง 2
Step 7: กลับไปตรวจสอบ Step 3
Step 8: ถ้า total >= Y ให้พิมพ์ count
Step 9: ถ้า total < Y ให้พิมพ์ -1
```
...
```text
เหมือนแผนแรก เพราะใช้วิธีบวกระยะกระโดดทีละ 2 เมตรและนับจำนวนครั้งไปเรื่อย ๆ จนถึงเป้าหมาย ถ้าระยะกระโดดหมดแล้วยังไม่ถึง ก็แสดง -1
```
...
```text
ดูว่าถ้าถีงเป้าหมายละแสดงค่าได้ถูกไหม
```
